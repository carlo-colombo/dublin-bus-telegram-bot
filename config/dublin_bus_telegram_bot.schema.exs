...
[
  ...
  mappings: [
    ...
    "maru.Elixir.DublinBusTelegramBot.http.port": [
      commented: false,
      datatype: :integer,
      default: 8081,
      doc: "Provide documentation for maru.Elixir.DublinBusTelegramBot.http.port here.",
      hidden: false,
      to: "maru.Elixir.DublinBusTelegramBot.http.port"
    ],
    "dublin_bus_telegram_bot.base_address": [
      commented: false,
      datatype: :binary,
